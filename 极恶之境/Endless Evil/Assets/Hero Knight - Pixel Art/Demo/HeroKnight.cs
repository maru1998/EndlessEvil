...
public class HeroKnight : MonoBehaviour {
    ...
    void Update ()
    {
       ...
       /* if (movement.x > 0)
        ...
        // Move
        /*if (!m_rolling )
            m_body2d.velocity = new Vector2(movement.x * m_speed, m_body2d.velocity.y);*/
    ...
    private void FixedUpdate()
    {
        ...
        //attack
        else if (Input.GetMouseButtonDown(0) && m_timeSinceAttack > 0.1f)
        {
            m_currentAttack++;
        ...
        //run 
        else if (Mathf.Abs(movement.x) > Mathf.Epsilon || Mathf.Abs(movement.y) > Mathf.Epsilon)
        {
            // Reset timer
            m_delayToIdle = 0.05f;
            m_animator.SetInteger("AnimState", 1);
